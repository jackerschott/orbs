...
ifeq ($(detected_OS),Windows)
	...
	INC_PATH_FLAGS := -IE:/Benutzerdateien/Documents/GitHub/black-hole-simulation/inc -I$(GTK_DIR)include/gtk-3.0 -I$(GTK_DIR)include/cairo -I$(GTK_DIR)include -I$(GTK_DIR)include/pango-1.0 -I$(GTK_DIR)include/fribidi -I$(GTK_DIR)include/atk-1.0 -I$(GTK_DIR)include/cairo -I$(GTK_DIR)include/pixman-1 -I$(GTK_DIR)include -I$(GTK_DIR)include/freetype2 -I$(GTK_DIR)include -I$(GTK_DIR)include/harfbuzz -I$(GTK_DIR)include/libpng16 -I$(GTK_DIR)include/gdk-pixbuf-2.0 -I$(GTK_DIR)include/libpng16 -I$(GTK_DIR)include -I$(GTK_DIR)include/glib-2.0 -I$(GTK_DIR)lib/glib-2.0/include -I$(GTK_DIR)include -I"$(CUDA_PATH)/include" -I$(CPP_LIB_DIR)SDL/include -I$(CPP_LIB_DIR)OpenGL/glew/include -I$(CPP_LIB_DIR)OpenGL/glm
